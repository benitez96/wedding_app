...
export default function RSVPReminderModal({ isOpen, onClose, onGoToRSVP }: RSVPReminderModalProps) {
  ...
  return (
    <Modal placement='center' isOpen={isOpen} onClose={onClose} size="md" isDismissable={false} hideCloseButton={false}>
      <ModalContent>
