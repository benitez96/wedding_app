...
export default function AdminLoginForm({ csrfData }: AdminLoginFormProps) {
        ...
        <Card className="shadow-lg">
          ...
          <CardBody>
            <Form action={formAction} className="space-y-6">
              {/* Campos hidden para CSRF */}
              <input
                type="hidden"
                name={csrfData.fieldName}
                value={csrfData.token}
              />
              <input type="hidden" name="_csrf_hash" value={csrfData.hash} />
