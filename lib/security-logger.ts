...
export async function logSecurityEvent(
  ...
  try {
    ...
    // Guardar en base de datos para auditoría (producción y desarrollo)
    try {
      ...
      // Si falla el guardado en DB, solo loggear el error (no interrumpir el flujo)
      console.error("Error guardando log de seguridad en DB:", dbError);
    }
  } catch (error) {
