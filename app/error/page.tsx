    ...
    switch (message) {
      ...
      case "token-ya-usado":
        return {
          ...
          description:
            "Esta invitación ya ha sido utilizada. Cada enlace de invitación solo puede ser utilizado una vez.",
      ...
      case "necesita-invitacion":
        return {
          ...
          description:
            "Para acceder a esta página necesitas un enlace de invitación. Por favor, contacta a los novios para obtener tu invitación.",
      ...
      case "error-verificando-autenticacion":
        return {
          ...
          description:
            "Ocurrió un error al verificar tu autenticación. Por favor, intenta acceder nuevamente con tu enlace de invitación.",
      ...
      case "error-procesando-token":
        return {
          ...
          description:
            "Ocurrió un error al procesar tu invitación. Por favor, intenta nuevamente.",
      ...
      case "rate-limit-exceeded":
        return {
          ...
          description:
            "Has excedido el límite de intentos. Por favor, espera un tiempo antes de intentar nuevamente.",
          icon: <Shield className="text-warning" size={48} />,
          color: "warning",
        };
      default:
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-secondary-50 p-4">
      <Card className="max-w-md w-full">
        ...
        <CardBody className="text-center">
          <p className="text-default-600 mb-6">{errorInfo.description}</p>
