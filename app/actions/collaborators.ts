 ...
 */
export const getEventCollaborators = withEventAuth(
  async (ctx) => {
    try {
 ...
 */
export const acceptInviteLink = withAuth(
...
export async function getInviteLinkInfo(token: string) {
  try {
    ...
    console.error("Error al obtener info del link:", error);
 ...
 */
export const getEventInviteLinks = withEventAuth(
  async (ctx) => {
    try {
